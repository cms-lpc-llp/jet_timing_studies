...
process.source = cms.Source("PoolSource",
   # fileNames = cms.untracked.vstring(options.inputFiles),
    ...
    '/store/data/Run2018A/ZeroBias/AOD/17Sep2018-v1/60001/103AABF8-CD82-B341-B242-449E15932540.root',
...
process.TFileService = cms.Service("TFileService",
	fileName = cms.string('jet_timing_studies_ZeroBias_Run2018A.root'),
